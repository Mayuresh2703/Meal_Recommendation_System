...
# path = "C:/Users/athar/Desktop/BE_PROJECT/new_mcdonaldata.csv"
col_names = ["item id", "item","servesize","calories","protien","totalfat","satfat","transfat","cholestrol","carbs","sugar","addedsugar","sodium","menu","Ratings"]

df = pd.read_csv(path, error_bad_lines=False,sep='/t')
    # print(df)
